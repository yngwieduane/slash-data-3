              ...
              return (
                <div
                  ...
                  onClick={() => {
                    ...
                    } else if (solution.id === 'wtheeq' && onNavigateToWtheeq) {
                      onNavigateToWtheeq();
                    } else if (solution.id === 'rabet' && onNavigateToRabetDetail) {
                      onNavigateToRabetDetail();
                    } else if (solution.id === 'rhoon' && onNavigateToRhoonDetail) {
                      onNavigateToRhoonDetail();
                    } else if (solution.id === 'shary' && onNavigateToSharyDetail) {
