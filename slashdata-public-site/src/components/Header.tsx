        ...
        <div className="flex justify-between items-center h-20">
          <div className="flex items-center">
            <button onClick={handleLogoClick} className="hover:opacity-80 transition-opacity cursor-pointer">
              <img src={logo} alt="SlashData" width={1145} height={364} className="h-8 w-auto" />
            </button>
          </div>
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <button onClick={() => navigateTo('/about')} className="text-[#000000] hover:text-[#00c7c5] transition-colors cursor-pointer">
              About Us
            </button>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-[#00c7c5]/20">
            <nav className="flex flex-col gap-4">
              ...
              <button onClick={() => navigateTo('/about')} className="text-[#000000] hover:text-[#00c7c5] transition-colors text-left cursor-pointer">
                About Us
              </button>
