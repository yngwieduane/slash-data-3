...
export function SolutionsPage({ onBack, onNavigateToRabetDetail, onNavigateToRhoonDetail, onNavigateToSharyDetail, onNavigateToWtheeqDetail }: any) {
  ...
  const solutions = [
    ...
    },
    {
      ...
      color: '#00c7c5',
      hasDetailPage: true,
      path: '/solutions/wtheeq' // Main Wtheeq page
    },
    {
      id: 4,
      name: 'Shary',
